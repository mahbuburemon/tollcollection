                  ...
                  <table id="order-listing" class="table table-striped" style="width:100%;">
                    ...
                    <tbody>
                      ...
                      <tr>
                          ...
                          <td>
                            <a href="{{('/user_view/'.$v_user->user_id)}}"> <button class="btn btn-outline-primary">View</button></a>
                            
                            <a href="{{('/user_edit/'.$v_user->user_id)}}"><button class="btn btn-outline-warning">Edit</button></a>

                            
                            <a href="{{('/user_delete/'.$v_user->user_id)}}" 
                            	id="delete"><button class="btn btn-outline-danger">Delete</button></a>
                          </td>
                      </tr>
