  ...
  <div class="container-scroller">
    ...
    <nav class="navbar navbar-light col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper">
        <a class="navbar-brand brand-logo" href="{{ url('/user_deshboard')}}"> Toll Collection </a>
      </div>
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <div class="user-info">
            <div class="profile">
              ...
              <img src="{{($user_info->user_image)}}" alt="logo">
            </div>
            <div class="details">
              <p class="user-name">{{strtoupper($user_info->user_name)}}</p>
          ...
          <ul class="nav">
            ...
            <!-- <li class="nav-item">
              <a class="nav-link" data-toggle="collapse" href="#layoutsSubmenu" aria-expanded="false" aria-controls="layoutsSubmenu">
                ...
                <span class="menu-title">User Amount</span>
              ...
              <div class="collapse" id="layoutsSubmenu">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="{{ url('/user_details_amount')}}">User Details Amount</a>
                  </li>
                </ul>
              </div>
            </li>
